  ...
  }
{
  ...
  {
    type === "image" ? <img onClick = {() => setZoomObj(fileInfo)} onLoad = {() => setIsLoaded(true)}  className = {` object-cover z-30 rounded-lg ${!isLoaded && ' hidden ' }`} src = {file} /> : <div className = 'grid place-content-center'>
      {
