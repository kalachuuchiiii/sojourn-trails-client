  ...
  }
{
  ...
  {
    type === "image" ? <img onClick = {() => setZoomObj(fileInfo)} onLoad = {() => setIsLoaded(true)}  className = {` object-contain z-50 rounded-lg ${!isLoaded && ' hidden ' }`} src = {file} /> : <div className = 'grid place-content-center'>
      {
